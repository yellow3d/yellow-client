...
T = TypeVar("T", bound="PaginatedCharacterRetopologyList")


@_attrs_define
class PaginatedCharacterRetopologyList:
    """
    Attributes:
        ...
        results (Union[Unset, List['CharacterRetopology']]):
    """

    count: Union[Unset, int] = UNSET
    next_: Union[None, Unset, str] = UNSET
    previous: Union[None, Unset, str] = UNSET
    results: Union[Unset, List["CharacterRetopology"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for results_item_data in _results or []:
            results_item = CharacterRetopology.from_dict(results_item_data)

            results.append(results_item)

        paginated_character_retopology_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_character_retopology_list.additional_properties = d
        return paginated_character_retopology_list
